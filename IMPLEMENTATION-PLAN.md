...
B3's seven-section essentials are implemented in the interface; its canonical
locality preparation remains required before C. The shared normalizer consumes a complete document, not a
